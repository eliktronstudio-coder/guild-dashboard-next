...
INSERT INTO "new_DropItem" ("activityId", "createdAt", "date", "id", "item", "playerId", "quantity", "status", "treasuryTransactionId", "value") SELECT "activityId", "createdAt", "date", "id", "item", "playerId", "quantity", "status", "treasuryTransactionId", "value" FROM "DropItem";
DROP TABLE "DropItem";
...
-- CreateIndex
CREATE UNIQUE INDEX "DropCatalogItem_name_key" ON "DropCatalogItem"("name");
